...
kube_apply: ## kube_apply - Taking in the service name, runs kubectl apply on ./<service>/kubernetes-deployment.yaml
	@if [ "${pod}" = "" ]; then                                        \
	...
	@echo "kubctl apply -f $(ROOT_DIR)/$(pod)/kubernetes-deployment.yaml"
